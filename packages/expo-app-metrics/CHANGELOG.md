...
- Persist observed network requests in the metrics database so they can be exported as telemetry. ([#48861](https://github.com/expo/expo/pull/48861) by [@tsapeta](https://github.com/tsapeta))
