...
- Hash the font file an `expo-font` Android family declares once for all of its definitions, as done with variable fonts. ([#48621](https://github.com/expo/expo/pull/48621) by [@vonovak](https://github.com/vonovak))
